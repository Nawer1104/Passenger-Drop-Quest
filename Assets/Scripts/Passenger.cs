...
public class Passenger : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        drawControl = DrawWithMouse.Instance;
    }
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        else if (collision != null && collision.gameObject.tag == gameObject.tag && gameObject.GetComponent<SpriteRenderer>().sprite == collision.GetComponent<SpriteRenderer>().sprite)
        {
            ReSetPos();
        }
        else
